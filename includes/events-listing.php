...
if (count($events) == 1 &&
	...
	$p->css[] = '/pages/_venue_type_slug_/_ct_event.slug_/_ct_event.slug_.css';
	$p->js[] = '/pages/_venue_type_slug_/_ct_event.slug_/_ct_event.slug_.js';
	include 'pages/_venue_type_slug_/_ct_event.slug_/_ct_event.slug_-settings.php';
	include 'pages/_venue_type_slug_/_ct_event.slug_/_ct_event.slug_-script.php';
	include 'pages/_venue_type_slug_/_ct_event.slug_/_ct_event.slug_.php';
